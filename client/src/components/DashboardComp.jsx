...
import {HiAnnotation, HiArrowNarrowUp, HiDocument, HiDocumentAdd, HiDocumentText, HiOutlineUserGroup} from 'react-icons/hi'
       ...
       <div className='flex flex-wrap gap-4 justify-center'>
        <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md '>
            ...
            <div className='flex gap-3 text-sm'>
               <span className='flex text-green-500 items-center'><HiArrowNarrowUp/>
               {lastMonthUsers}</span>
